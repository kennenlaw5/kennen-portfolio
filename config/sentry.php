...
return [
    ...
    // Keep the final Error-event privacy boundary cache-safe and centrally testable.
    'before_send' => [SentryTelemetrySanitizer::class, 'beforeSend'],

    // Disable core SDK defaults; the final adapter also strips Laravel-added context.
    'default_integrations' => env('SENTRY_DEFAULT_INTEGRATIONS', false),

    // Breadcrumbs are excluded from this Error Monitoring phase.
    'max_breadcrumbs' => (int) env('SENTRY_MAX_BREADCRUMBS', 0),
